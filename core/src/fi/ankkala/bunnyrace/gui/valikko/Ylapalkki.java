...
public class Ylapalkki implements Valikko {
	...
	public Ylapalkki(GameControl gc) {
		...
		this.ylaosa = new Texture(
				AssetLoader.load("ylareuna1_credits.png"));
		this.fontti = new BitmapFont(
				AssetLoader.load("fontti.fnt"));
	...
	public void piirra() {
		batch.begin();
		batch.draw(ylaosa, 0, korkeus - palkinKorkeus, leveys, palkinKorkeus,
				0, 1, 1, 0);
		// fontti.draw(batch, "BunnyRace", leveys/2-110,
		// korkeus-palkinKorkeus*0.1f);
	...
	public void resize(int w, int h) {
		...
		skaala = Math.min((float) w / 640f, (float) palkinKorkeus / 45f);
